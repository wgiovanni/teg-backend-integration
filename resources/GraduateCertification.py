...
workspace.import_model("resources/cubesmodel/model_graduate_certification.json")
browser = workspace.browser("fact_egresado_certificacion")


class GraduateCertification(BD, Resource):
    ...
    def get(self):
        try:
            ...
            r = browser.aggregate(drilldown=["dim_egresado", "dim_certificacion"])
            for row in r:
                print(row)
                print("\n")
