...
workspace.import_model("resources/cubesmodel/model_graduate_courses.json")
browser = workspace.browser("fact_egresado_cursos")


class GraduateCourses(BD, Resource):
    ...
    def get(self):
        try:
            ...
            r = browser.aggregate(drilldown=["dim_egresado", "dim_cursos"])
            for row in r:
                print(row)
                print("\n")
