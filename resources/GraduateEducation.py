...
workspace.import_model("resources/cubesmodel/model_graduate_education.json")
browser = workspace.browser("fact_egresado_educacion")


class GraduateEducation(BD, Resource):
    ...
    def get(self):
        try:
            ...
            r = browser.aggregate(drilldown=["dim_egresado", "dim_educacion"])
            for row in r:
                print(row)
                print("\n")
