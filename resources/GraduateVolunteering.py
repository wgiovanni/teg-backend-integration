...
workspace.import_model("resources/cubesmodel/model_graduate_volunteering.json")
browser = workspace.browser("fact_egresado_voluntariado")


class GraduateVolunteering(BD, Resource):
    ...
    def get(self):
        try:
            ...
            r = browser.aggregate(drilldown=["dim_egresado", "dim_voluntariado"])
            for row in r:
                print(row)
                print("\n")
